...
const createBook = async function (req, res) {
    ...
    try {
        ...
        if (typeof (excerpt) != "string") { return res.status(400).send({ status: false, message: "Please provide the excerpt in string" }) }
        excerpt = bookData.excerpt = excerpt.trim()

        if (typeof (ISBN) != "string") { return res.status(400).send({ status: false, message: "Please provide the ISBN in string" }) }
...
const updateBook = async function (req, res) {
    ...
    try {
        ...
        if (releasedAt) {
            ...
            if (typeof (releasedAt) != "string") { return res.status(400).send({ status: false, message: "Please provide releaseAt in string to update book" }) }
        ...
        if (excerpt) {
            ...
            if (typeof (excerpt) != "string") { return res.status(400).send({ status: false, message: "Please provide excerpt in string to update book" }) }
